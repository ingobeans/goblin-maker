...
impl Default for Assets {
    fn default() -> Self {
        ...
        Self {
            ...
            pause_btn: Animation::from_file(include_bytes!("../assets/ui/pause_btn.ase")),
            pause_btn_topbar: Animation::from_file(include_bytes!(
                "../assets/ui/pause_btn_topbar.ase"
            )),
